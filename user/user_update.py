...
from PyQt5.QtWidgets import QButtonGroup,QMainWindow,QMessageBox
...
class Ui_MainWindow(QMainWindow):
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "用户信息修改"))
        self.register_btn.setText(_translate("MainWindow", "修改"))
    ...
    def btn_click(self):
        ...
        libsql.update_user(self.userid,name,phone,department,title)
        ...
        if passwd != "":
            libsql.update_passwd(self.userid,passwd)
            QMessageBox.about(self,"通知","修改密码成功\n请牢记您的密码:\n %s" %passwd)
        else:
            QMessageBox.about(self,"通知","修改用户信息成功")
